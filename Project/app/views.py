...
def analysis(request):
    ...
    fig1 = go.Figure()
    fig1.add_trace(go.Bar(x=ratings,y=past_contests_problems_accepted_by_rating, name='Accepted Submissions in Contest'))
    fig1.add_trace(go.Bar(x=ratings,y=past_contests_problems_attempted_by_rating, name='Total Submissions in Contest'))
    chart1 = fig1.to_html
